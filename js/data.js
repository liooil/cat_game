const MORANDI_COLORS = [
    [163, 172, 161], // 鼠尾草绿 (#A3ACA1)
    [184, 158, 151], // 灰豆沙 (#B89E97)
    [166, 172, 186], // 雾霾蓝 (#A6ACBA)
    [204, 192, 179], // 暖灰棕 (#CCC0B3)
    [191, 184, 196], // 香芋紫 (#BFB8C4)
    [176, 196, 222], // 莫兰迪蓝 (#B0C4DE)
    [222, 184, 135]  // 沙驼色 (#DEB887)
];
